-module(gol).
-export([new/2, query/3, print/1, draw/1, demo_grid/0, count_neighbors/3, run_simulation/2]).
...
run_simulation(Grid, Generations) ->
    ...
    case Generations > 0 of
        true ->
            run_simulation(UpdatedGrid, Generations - 1);
        false -> end_simulation()
end.

end_simulation() ->
    io:format("~n End of simulation").
